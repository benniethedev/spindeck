...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "SpinRec — Promote Your Music to Top DJs" }],
  },
  twitter: {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="/#how-it-works" className="text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">How It Works</a></li>
              <li><a href="/#pricing" className="text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">Pricing</a></li>
              <li><a href="/artist" className="text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">For Artists</a></li>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(124,58,237,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(124,58,237,0.08),transparent)]" />
        {/* decorative blobs */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-violet-300/20 dark:bg-violet-600/10 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-indigo-300/15 dark:bg-indigo-600/10 rounded-full blur-3xl" />

        <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 sm:pt-36 sm:pb-28 lg:pt-44 lg:pb-36">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {HOW_IT_WORKS.map((item) => (
              <div key={item.step} className="relative group">
                ...
                <div className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 bg-white dark:bg-zinc-950 hover:border-violet-300 dark:hover:border-violet-800 transition-all duration-300">
            ...
            {PRICING_PLANS.map((plan) => (
              <div
                ...
                className={`relative rounded-2xl border p-8 flex flex-col transition-all duration-300 ${
                  plan.highlighted
                    ? "border-violet-500 bg-white dark:bg-zinc-900 shadow-xl shadow-violet-500/10 md:scale-105 z-10"
                    : "border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 hover:border-violet-200 dark:hover:border-violet-800"
                }`}
              >
                {plan.highlighted && (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {TESTIMONIALS.map((t) => (
              <div
                key={t.author}
                className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 bg-white dark:bg-zinc-950 hover:border-violet-200 dark:hover:border-violet-800 transition-all duration-300"
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {FEATURED_ARTISTS.map((artist) => (
              <div
                key={artist.name}
                className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 bg-white dark:bg-zinc-950 hover:border-violet-300 dark:hover:border-violet-800 transition-all duration-300 text-center"
              >
