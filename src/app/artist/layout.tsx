...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "SpinRec",
    title: "Artist Portal — Promote Your Music to Top DJs | SpinRec",
    description: "Submit your music to thousands of curated DJs worldwide. Get approved, get promoted, and grow your audience.",
    url: "/artist",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "SpinRec Artist Portal — Promote Your Music to Top DJs",
      },
    ],
  },
  twitter: {
